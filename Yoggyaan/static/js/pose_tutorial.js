(function () {
  ...
  const missions = {
    ...
    setu_bandhasana: {
      title: "Setu Bandhasana (Bridge Pose) - Step Missions",
      intro: "Learn Bridge Pose step by step: lie down, bend knees, lift hips, then optionally clasp hands under the back.",
      reward: "+20 Training XP • Bridge Badge",
      steps: [
        { title: "Mission 1: Lie On Back", instruction: "Lie on your back with arms beside the body.", xp: 5, check: checkGenericReady },
        { title: "Mission 2: Bend Knees", instruction: "Bend both knees and place feet flat near your hips.", xp: 5, check: checkGenericReady },
        { title: "Mission 3: Lift Hips Up", instruction: "Press feet down and lift hips upward into a bridge.", xp: 5, check: checkGenericReady },
        { title: "Mission 4: Clasp Hands", instruction: "Optionally clasp hands under your back and hold the bridge shape.", xp: 5, check: checkGenericReady },
      ],
    },
    padahastasana: {
  ...
  const POSE_STEPS = {
    ...
    setu_bandhasana: [
      { body: { head: [48, 168, 13], spine: [62, 168, 128, 168], shoulders: [64, 166, 100, 166], hips: [130, 168, 154, 168], ground: [110, 214, 100, 8] }, arms: { la: [70, 168, 96, 188], lf: [96, 188, 125, 190], ra: [92, 168, 118, 188], rf: [118, 188, 146, 190], ll: [150, 168, 178, 168], lc: [178, 168, 200, 168], rl: [150, 172, 178, 172], rc: [178, 172, 200, 172] }, guide: "1/4: Lie on your back with body long on the floor.", focus: [[48, 168, 5]], move: [] },
      { body: { head: [48, 168, 13], spine: [62, 168, 126, 168], shoulders: [64, 166, 100, 166], hips: [130, 168, 154, 168], ground: [110, 214, 100, 8] }, arms: { la: [70, 170, 96, 190], lf: [96, 190, 125, 192], ra: [92, 170, 118, 190], rf: [118, 190, 146, 192], ll: [150, 168, 168, 138], lc: [168, 138, 188, 190], rl: [152, 172, 176, 138], rc: [176, 138, 204, 190] }, guide: "2/4: Bend knees and keep both feet flat.", focus: [[188, 190, 5], [204, 190, 5]], move: [[184, 168, 168, 138], [198, 170, 176, 138]] },
      { body: { head: [48, 172, 13], spine: [62, 170, 118, 132], shoulders: [64, 168, 100, 152], hips: [118, 132, 158, 112], ground: [110, 214, 100, 8] }, arms: { la: [70, 170, 96, 190], lf: [96, 190, 128, 192], ra: [92, 166, 118, 188], rf: [118, 188, 146, 190], ll: [158, 112, 174, 140], lc: [174, 140, 194, 190], rl: [158, 116, 184, 142], rc: [184, 142, 208, 190] }, guide: "3/4: Press feet down and lift hips up into a bridge.", focus: [[158, 112, 7]], move: [[146, 168, 158, 112]] },
      { body: { head: [48, 172, 13], spine: [62, 170, 118, 132], shoulders: [64, 168, 100, 152], hips: [118, 132, 158, 112], ground: [110, 214, 100, 8] }, arms: { la: [70, 170, 96, 190], lf: [96, 190, 132, 190], ra: [92, 166, 118, 188], rf: [118, 188, 132, 190], ll: [158, 112, 174, 140], lc: [174, 140, 194, 190], rl: [158, 116, 184, 142], rc: [184, 142, 208, 190] }, guide: "4/4: Optionally clasp hands under back and hold the bridge.", focus: [[132, 190, 6], [158, 112, 6]], move: [[96, 190, 132, 190], [118, 188, 132, 190]] },
    ],
