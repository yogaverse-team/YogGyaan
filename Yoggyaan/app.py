...
HOLD_POSES = {"tree", "padmasana", "baddha_konasana", "vajrasana", "tadasana", "setu_bandhasana", "bhujangasana", "wall_plank_chaturanga", "padahastasana", "paschimottanasana", "paschim_namaskarasana", "pranayama", "warrior"}
...
def load_asana_metadata():
    ...
    route_to_key = {
        ...
        "/game/setu_bandhasana": "setu_bandhasana", "/game/padahastasana": "padahastasana",
...
def build_wellness_analytics(db, uid):
    ...
    category_map = {'pranayama':'Breath Practice','padmasana':'Meditation','vajrasana':'Meditation','tree':'Balance','trikonasana':'Balance','warrior':'Strength',
                    ...
                    'setu_bandhasana':'Strength','bhujangasana':'Flexibility','baddha_konasana':'Flexibility',
...
SETU_BANDHASANA_RESTORATION_STAGES = [
    (0, ""),
...
RESTORATION_STAGES_MAP = {
    ...
    "setu_bandhasana": SETU_BANDHASANA_RESTORATION_STAGES,
...
def check_achievements(db, user_id, pose_name, accuracy, levels_completed,
    ...
    if pose_name == "tree":
        ...
        award("Bridge Builder", "Completed your first Bridge Pose and began reconnecting the kingdom", "route")
    ...
    if accuracy >= 85 and pose_name == "setu_bandhasana":
        award("Pathfinder", "Achieved 85%+ accuracy in Bridge Pose", "bridge")
    ...
    if {"tree", "warrior", "padmasana", "vajrasana", "baddha_konasana", "tadasana", "trikonasana", "setu_bandhasana", "bhujangasana", "wall_plank_chaturanga", "padahastasana", "paschimottanasana", "paschim_namaskarasana", "pranayama"}.issubset(poses_done):
...
WORLD_REGIONS = [
    ...
    {"pose":"setu_bandhasana", "region":"United Kingdoms", "biome":"Bridge kingdom", "theme":"Connection and support", "icon":"🌉", "color":"#fb7185", "x":64, "y":72, "col":"kingdoms_restoration", "desc":"Separated kingdoms rebuild bridges, roads, markets, ships, and flags through Bridge Pose."},
...
POSE_DISPLAY_NAMES = {
    ...
    "setu_bandhasana":"Setu Bandhasana / Bridge Pose", "bhujangasana":"Bhujangasana / Cobra Pose",
...
POSE_TO_REGION = {
    ...
    "setu_bandhasana": "kingdoms_restoration",
...
def get_or_create_daily_challenge(db):
    ...
    if row:
        return dict(row)
    poses = ["tree", "warrior", "padmasana", "vajrasana", "baddha_konasana", "tadasana", "trikonasana", "setu_bandhasana", "bhujangasana", "wall_plank_chaturanga", "padahastasana", "paschimottanasana", "paschim_namaskarasana", "pranayama"]
    ...
    descriptions = {
        ...
        "setu_bandhasana": "Complete 5 Bridge Pose reps to unite the kingdom",
...
def get_daily_challenges_board():
    poses = [
        ...
        ("setu_bandhasana", "Bridge Pose", "Lift hips and hold a stable bridge shape."),
...
ALL_POSES = {"tree", "warrior", "padmasana", "vajrasana", "baddha_konasana", "tadasana", "trikonasana", "setu_bandhasana", "bhujangasana", "wall_plank_chaturanga", "padahastasana", "paschimottanasana", "paschim_namaskarasana", "pranayama"}
...
def dashboard():
    ...
    setu_mastery = get_or_create_mastery(db, uid, "setu_bandhasana")
